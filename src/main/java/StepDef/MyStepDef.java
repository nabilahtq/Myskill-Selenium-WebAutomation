...
public class MyStepDef extends env_target{
    ...
    public void userInputName() {
        //tradisional
        //driver.findElement(By.id("customer.firstName")).sendKeys("Cipung");
        //driver.findElement(By.id("customer.lastName")).sendKeys("Abubu");

        //pom
        registerPages inputName = new registerPages(driver);
        inputName.inputNameData("Cipung","Abubu");
    }
    ...
    public void userInputAddressDetail() {
        ...
        //User input State
        driver.findElement(By.xpath("//*[@id='customer.address.state']")).sendKeys("Negara");
        //User input ZipCode
